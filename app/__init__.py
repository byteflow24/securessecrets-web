...
def create_app():
    ...
    def add_security_headers(response):
        ...
        response.headers["Content-Security-Policy"] = (
            ...
            "img-src 'self' data: https://*.google-analytics.com https://*.googlesyndication.com; "
            "connect-src 'self' https://*.googletagmanager.com https://*.google-analytics.com https://*.adtrafficquality.google; "
            "frame-src 'self' https://*.googletagmanager.com https://*.googlesyndication.com https://*.doubleclick.net; "
